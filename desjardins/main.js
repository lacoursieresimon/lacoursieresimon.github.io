...
var routes = [
    ...
    { path: 'claim', loadChildren: './claim/claim.module#ClaimPageModule' },
];
...
/* harmony import */ var _modal_modal_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal/modal.page */ "./src/app/modal/modal.page.ts");
...
/* harmony import */ var _services_SocketService__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/SocketService */ "./src/services/SocketService.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _modal_modal_page__WEBPACK_IMPORTED_MODULE_9__["ModalPage"]],
            entryComponents: [_modal_modal_page__WEBPACK_IMPORTED_MODULE_9__["ModalPage"]],
            imports: [
            ...
            providers: [
                ...
                _services_SocketService__WEBPACK_IMPORTED_MODULE_11__["SocketService"]
            ],
...
module.exports = "<ion-header>\r\n    <ion-toolbar color=\"beige\">\r\n        <ion-title>\r\n            Notifications ({{ notifications.length }})\r\n        </ion-title>\r\n    </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n    <ion-list>\r\n        <ion-item *ngFor=\"let notification of notifications\" (click)=\"executeAction(notification.route)\">\r\n                <ion-label text-wrap>\r\n                    <ion-text>\r\n                        <h2>{{ notification.text }}</h2>\r\n                    </ion-text>\r\n                </ion-label>\r\n                <ion-button fill=\"clear\" size=\"medium\" color=\"forest\" slot=\"end\" >\r\n                    <ion-icon name=\"arrow-forward\"></ion-icon>\r\n                </ion-button>\r\n        </ion-item>\r\n    </ion-list>\r\n</ion-content>"
...
var ModalPage = /** @class */ (function () {
    function ModalPage(navParams, modalController, navController) {
        this.modalController = modalController;
        this.navController = navController;
        this.notifications = navParams.data.notifications;
    }
    ModalPage.prototype.executeAction = function (navigateToRoute) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.navController.navigateRoot(navigateToRoute)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])
    ], ModalPage);
    return ModalPage;
}());
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.watchServiceValidation = function () {
        return this.watchForMessage('service-validation');
    };
    SocketService.prototype.watchProviderValidation = function () {
        return this.watchForMessage('provider-validation');
    };
    SocketService.prototype.watchLocationValidation = function () {
        return this.watchForMessage('location-validation');
    };
    SocketService.prototype.watchAdmissibleRefund = function () {
        return this.watchForMessage('admissible-refund');
    };
    SocketService.prototype.watchForMessage = function (message) {
        var _this = this;
...
module.exports = __webpack_require__(/*! C:\Users\Simon\Documents\Git\desjardins-insurance-app\app\src\main.ts */"./src/main.ts");
